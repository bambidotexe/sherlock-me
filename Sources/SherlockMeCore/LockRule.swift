...
public struct LockRule: Sendable {
    ...
    public enum Reason: Equatable, Sendable {
        ...
        /// This press has had its one relock: made, or dropped because the screen locked first.
    ...
    /// word than the log's; an unlock the log missed leaves at most one press to macOS.
