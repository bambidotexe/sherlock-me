...
public enum AppIdentity {
    ...
    public static let name: String = string("CFBundleName") ?? "SherlockMe"

    public static let bundleIdentifier: String = Bundle.main.bundleIdentifier ?? "dev.rubens.SherlockMe"
    ...
    public static let repository: String = string("AppUpdateRepository") ?? "bambidotexe/sherlock-me"
