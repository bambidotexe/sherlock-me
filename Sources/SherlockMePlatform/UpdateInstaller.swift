...
/// Whether this app can replace itself where it is installed, and the start of the helper that does it once
/// the app has quit (`UpdateInstallScript`).
public enum UpdateInstaller {
    public enum Obstacle: String, Sendable {
        ...
        case translocated
        case notWritable
        /// The update is unpacked on another volume than the app's, where a move is a copy and not one
        /// rename.
        case otherVolume
    }
