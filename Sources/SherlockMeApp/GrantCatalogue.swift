...
/// What a grant is, how the front is given back after one, and the lists the onboarding wizard's pages
/// are made of. This file is the family's reference copy; read the `macos-building-onboarding` skill
...
/// The rows of the wizard's list pages.
///
...
enum GrantCatalogue {
    ...
    /// dialog offers to. Unused until the app has a permission row; kept so that the row is written the
