...
struct GeneralPage: View {
    ...
    /// the app in System Settings › General › Login Items without ever opening this window. The switch
    ...
    var body: some View {
        ...
        SettingsPage {
            ...
            // The app's own switches live on its feature pages, never here. With the icon hidden its menu
            // is hidden with it, so the way back to this window has to be named.
