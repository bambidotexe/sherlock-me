...
/// The Settings window's chrome. This file is the family's reference copy; the `macos-building-settings-pages`
/// skill is the contract it keeps.
///
/// The app is an accessory that never activates itself. This window is the one deliberate exception:
...
final class SettingsWindow: NSObject, NSWindowDelegate, NSToolbarDelegate {
    ...
    init(store: SettingsStore, othersNeedUsActive: @escaping @MainActor () -> Bool) {
