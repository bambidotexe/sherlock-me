#!/bin/sh
# Wraps an already-built, already-signed SherlockMe.app in the disk image a release ships: the app, an
# Applications folder beside it, and a backdrop naming the app and pointing from one to the other.
#
#   scripts/make-dmg.sh [path to SherlockMe.app] [output.dmg]
#
...
# .dmg with SherlockMe.app at the image's root, a CFBundleShortVersionString strictly newer than the copies
